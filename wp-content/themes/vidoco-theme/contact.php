						...
						<div class="col-md-5">
							<div class="logo-contact">
								<a href="<?php echo site_url( '', null ); ?>">
									<figure>
										<div style="background-image: url('<?php echo get_field("setting_thong_tin_chung_favicon","option"); ?>');background-repeat: no-repeat;background-size: cover;padding-top: calc(100% / (215/50));"></div>
									</figure>
								</a>
							</div>
