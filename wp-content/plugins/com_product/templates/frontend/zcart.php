    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="margin-top-15">
                ...
                if(count(@$arrCart) > 0){
                    ?>
                    <form method="POST" name="com_product_zcart" class="margin-top-5">
                        ...
                        <table class="com-product-cart" cellpadding="0" cellspacing="0" width="100%" >
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="3">
                                        <a href="<?php echo site_url('index.php?action=delete-all',null); ?>" onclick="return xacnhanxoa('Bạn có chắc chắn muốn xóa ?');" class="com-product-xoa-gio-hang"><span><i class="far fa-trash-alt"></i></span><span class="margin-left-5">Xóa giỏ hàng</span></a>
                                        <a href="javascript:void(0);" onclick="document.forms['com_product_zcart'].submit();" class="com-product-xoa-gio-hang" ><span><i class="fas fa-sync-alt"></i></span><span class="margin-left-5" >Cập nhật</span></a>
                                        <a href="<?php echo site_url( '',null ); ?>" class="com-product-xoa-gio-hang"><span><i class="fas fa-home"></i></span><span class="margin-left-5">Tiếp tục mua hàng</span> </a>
                                        <a href="<?php echo @$permarlink_checkout; ?>" class="com-product-xoa-gio-hang"><span><i class="fas fa-money-bill-wave"></i></span> <span class="margin-left-5">Thanh toán</span></a>
                                    </td>
